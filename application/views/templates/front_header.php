...
<head>
    ...
    <!-- Bootstrap Styles -->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/'); ?>vendors/bootstrap/css/bootstrap.css">

    <!-- Components Vendor Styles -->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/'); ?>vendors/font-awesome/css/fontawesome-all.min.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/'); ?>vendors/slick-carousel/slick.css">
